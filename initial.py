...
def init_param():
    ...
    parser.add_argument('--b', type=float, default=100, help='b')
    parser.add_argument('--c', type=float, default=100, help='c')
    ...
    parser.add_argument('--ablation-mode', type=str, default='c')
